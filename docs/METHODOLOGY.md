...
This document describes Apocalypse Clock model 1.3.0 with dataset 1.9.0. It is an experimental scenario model, not a peer-reviewed or empirically validated forecast. Numerical conventions below describe the implementation; they are not measurements of collapse probability.

...
These rules describe model 1.3.0 with dataset 1.9.0. They protect the declared model and its interpretation, not a claim of scientific validity. Changing them requires an explicit MODEL change and review.
